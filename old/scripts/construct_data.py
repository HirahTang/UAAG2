...
def json_to_torch_geometric_data(json_path):
    ...
    # save the data_list
    # embed()
    torch.save(data_list, f"/home/qcx679/hantang/UAAG2/data/full_graph/full_graph_debug.pt")
path = "/home/qcx679/hantang/UAAG2/data/processed/uaag_aa_eqgat_test.json"
# path = "/home/qcx679/hantang/UAAG2/data/processed/uaag_aa_eqgat_8.json"
json_to_torch_geometric_data(path)
