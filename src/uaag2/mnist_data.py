...
def corrupt_mnist() -> tuple[torch.utils.data.Dataset, torch.utils.data.Dataset]:
    ...
    train_images = torch.load("data/mnist/processed/train_images.pt")
    train_target = torch.load("data/mnist/processed/train_target.pt")
    test_images = torch.load("data/mnist/processed/test_images.pt")
    test_target = torch.load("data/mnist/processed/test_target.pt")
