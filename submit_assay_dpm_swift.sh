...
# ============================================================================
# UAAG DPM-Solver++ Swift Pipeline Submission Script
# ============================================================================
...
echo "============================================================================"
echo "DPM-Solver++ Assay Submission"
...
WRAP
    ...
    SAMPLING_JOB=$(sbatch --parsable \
        ...
        --time=2-00:00:00 \
        --array=${array_range} \
        -o "${LOG_DIR}/dpm_samp_${assay_name}_%A_%a.log" \
        -e "${LOG_DIR}/dpm_samp_${assay_name}_%A_%a.log" \
        --job-name="DPM_samp_${assay_name}" \
        --export=ALL \
...
WRAP
    ...
    POSTPROC_JOB=$(sbatch --parsable \
        ...
        --mem=60G \
        --time=2-00:00:00 \
        -o "${LOG_DIR}/dpm_post_${assay_name}_%j.log" \
        -e "${LOG_DIR}/dpm_post_${assay_name}_%j.log" \
        --job-name="DPM_post_${assay_name}" \
...
WRAP
    ...
    PB_JOB=$(sbatch --parsable \
        ...
        --mem=60G \
        --time=2-00:00:00 \
        -o "${LOG_DIR}/dpm_pb_${assay_name}_%j.log" \
        -e "${LOG_DIR}/dpm_pb_${assay_name}_%j.log" \
        --job-name="DPM_pb_${assay_name}" \
