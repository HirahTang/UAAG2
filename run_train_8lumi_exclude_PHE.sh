...
#SBATCH -o logs/train_%j_8GPUs0208EXCLUDEPHE.log
#SBATCH -e logs/train_%j.log


DATA_PATH=/scratch/project_465002574/unaagi_exclude_PHE.lmdb
MODEL=UAAG_model_official_8
DATA_INFO_PATH=/flash/project_465002574/UAAG2_main/data/statistic.pkl
METADATA_PATH=/scratch/project_465002574/unaagi_exclude_PHE.metadata.pkl
