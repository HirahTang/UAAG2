#!/bin/bash
#SBATCH --job-name=UAAG_v0.3_ring_w8gpu
...
#SBATCH -o /flash/project_465002574/UAAG2_main/logs/train_flagship_v0.3_ring_weighted_%j.log
#SBATCH -e /flash/project_465002574/UAAG2_main/logs/train_flagship_v0.3_ring_weighted_%j.log
...
RUN_ID=Flagship_v0.3_ring_weighted_8gpu_20260531
