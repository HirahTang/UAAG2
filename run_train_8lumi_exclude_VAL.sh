...
#SBATCH -o logs/train_%j_8GPUs0208EXCLUDEVAL.log
#SBATCH -e logs/train_%j.log


DATA_PATH=/scratch/project_465002574/unaagi_exclude_VAL.lmdb
MODEL=UAAG_model_official_8
DATA_INFO_PATH=/flash/project_465002574/UAAG2_main/data/statistic.pkl
METADATA_PATH=/scratch/project_465002574/unaagi_exclude_VAL.metadata.pkl
...
python scripts/run_train.py \
  ...
  --num_nodes 1 \
  --id Full_mask_8_gpu_${MODEL}_EXCLUDE_VAL_0208 --max-virtual-nodes 5 --use_metadata_sampler \
  --training_data $DATA_PATH \
  --data_info_path $DATA_INFO_PATH \
  --metadata_path $METADATA_PATH --num-workers 4 \
  --load-ckpt /flash/project_465002574/UAAG2_main/3DcoordsAtomsBonds_0/runFull_mask_8_gpu_UAAG_model_official_8_EXCLUDE_VAL_0208/last.ckpt