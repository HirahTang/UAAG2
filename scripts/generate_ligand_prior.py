...
from uaag.data.uaag_dataset import UAAG2DataModule, UAAG2Dataset, UAAG2Dataset_sampling, UAAG2Dataset_sampling_prior, Dataset_Info
...
def main(hparams):
    ...
    dataset = UAAG2Dataset_sampling_prior(graph, hparams, save_path, dataset_info, sample_size=hparams.virtual_node_size, sample_length=hparams.num_samples)
